...
function extractQuoteFormData(formData: FormData) {
  return {
    ...
    adjuvantSurfactant: String(formData.get("adjuvantSurfactant") ?? ""),
    pricePerAcre: String(formData.get("pricePerAcre") ?? ""),
...
export async function createQuoteAction(
  ...
  const { data: quote, error: quoteError } = await supabase
    ...
    .insert({
      ...
      adjuvant_surfactant: parsed.data.adjuvantSurfactant ?? null,
      price_per_acre: parsed.data.pricePerAcre ?? null,
