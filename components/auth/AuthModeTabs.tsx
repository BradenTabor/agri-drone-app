        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive
                ? "bg-white text-auth-accent-strong shadow-[inset_0_1px_0_rgba(255,255,255,0.95),0_4px_14px_rgba(15,23,42,0.1)]"
                : "text-slate-600 hover:bg-white/70 hover:text-auth-accent-strong",
            )}
          >
            {label}
          </Link>
